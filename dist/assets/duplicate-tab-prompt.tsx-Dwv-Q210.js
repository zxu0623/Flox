import{t as a}from"./i18n-CNAd9DTq.js";let e=null,t=null,l=null;function d(){e&&t||(e=document.createElement("div"),e.style.position="fixed",e.style.bottom="20px",e.style.left="50%",e.style.transform="translateX(-50%)",e.style.zIndex="2147483646",t=e.attachShadow({mode:"open"}),document.documentElement.appendChild(e))}function p(){l=null,e&&e.remove(),e=null,t=null}function s(){var i,o;if(!t||l===null)return;const r=`
